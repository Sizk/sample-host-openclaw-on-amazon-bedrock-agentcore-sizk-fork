...
const AGENTS_MD_CONTENT = [
  ...
  "",
  "### When to use sub-agents (MANDATORY — never skip this):",
  "**ALWAYS use `spawn_subagents` for these — NEVER run them directly in the main loop:**",
  ...
  "- Any task involving exec/bash commands that take more than ~10 seconds",
  "",
  ...
  "and the user can keep chatting. This is a HARD UX requirement — never violate it.",
  "",
