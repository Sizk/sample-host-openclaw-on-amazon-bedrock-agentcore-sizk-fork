...
const AGENTS_MD_CONTENT = [
  ...
  "",
  "### PDF generation (markdown → HTML → PDF pipeline):",
  "",
  "Pre-installed: `markdown`, `xhtml2pdf`. Write content as markdown, convert to PDF:",
  "```",
  "1. Write markdown to /tmp/content.md using bash",
  "2. bash: python3 /tmp/md2pdf.py   (see script below)",
  "3. s3-user-files write: write_user_file report.pdf --file=/tmp/report.pdf",
  "4. Response: 'Here is your report! [SEND_FILE:report.pdf]'",
  "```",
  "",
  "Use this md2pdf.py script (write it with bash before running):",
  "```python",
  "import markdown",
  ...
  "```",
  "",
  "IMPORTANT: Never use fpdf2 for complex content — it can't handle text wrapping or links properly.",
  "Always use the markdown → xhtml2pdf pipeline for quality PDFs.",
  "",
